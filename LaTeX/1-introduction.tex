...
\centering
	...
	\caption{Generic training scheme of \emph{InferSent}, adapted from \cite{Conneau:2017aa} }
		\label{img:versus}
\end{figure}
The basic idea is similar to word embeddings. A neural network is trained on a suitable task, and the embeddings are extracted from a weight matrix of a hidden layer.
