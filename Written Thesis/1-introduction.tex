...
\label{sec:argth}
\label{sec:argmine}
In the following, publications on argument mining are presentend. If appropriate, the f1 scores achieved in these publications are presentend as well. It must be noted that the f1 scores are not comparable with each other.
