...
Examples of Comparative Portals are \emph{Check24.de\footnote{https://check24.de (checked: 13.04.2018)}, Verivox.de\footnote{https://verivox.de (checked: 13.04.2018)}, Idealo.de\footnote{https://idealo.de (checked: 13.04.2018)}, GoCompare.com\footnote{https://gocompare.com (checked: 13.04.2018)},} and \emph{Compare.com}\footnote{https://compare.com (checked: 13.04.2018)} just to name a few.
...
Another interesting type of websites are Question Answering Portals like \emph{Quora.com}\footnote{https://quora.com (checked: 13.04.2018)} or \emph{GuteFrage.net}\footnote{https://gutefrage.net (checked: 13.04.2018)}. Although comparisons are not their primary goal, a lot of comparative questions are present on those sites.
...
More interestingly are systems which can compare any objects on arbitrary properties, like \emph{Diffen.com}\footnote{https://diffen.com (checked: 13.04.2018)} and \emph{Versus.com}\footnote{https://versus.com (checked: 13.04.2018)}.
