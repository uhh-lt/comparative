...
1& Is \textbf{football} better than \textbf{baseball}? & BETTER & NONE & 1.0\\
2& Is \textbf{Microsoft} better because of \textbf{Apple}? & BETTER & NONE & 1.0\\
 
3& The \textbf{Buick} is a far better driver but doesn't have the wretched excess appeal of the \textbf{Cadillac}. & BETTER & NONE & 1.0\\
4&They know that \textbf{Lexus} has better residual, and that \textbf{Audi} has better tech. & BETTER & NONE & 1.0\\
 
5& Its Azure PaaS/IaaS platform hasn't overtaken \textbf{Amazon} yet in market share, but \textbf{Microsoft} has enjoyed nine straight quarters of growth at 10 percent or better & NONE & WORSE & 1.0\\
 
 6& I think I found a better \textbf{sandwich} than a cheese \textbf{steak}. & NONE & BETTER & 1.0\\
 
7&  \textbf{harvard} College accepted just 6.9 percent, its lowest rate ever, and the numbers were not much better elsewhere: 7.2 percent at Stanford,8.2 percent at Princeton, 11.5 percent at \textbf{dartmouth}, and 23 percent at Northwestern-all record lows. & WORSE & NONE & 0.4\\
\bottomrule
\end{tabularx}
\end{table}
...
\toprule
 & Sentence & Predicted & Gold & Confidence \\ \midrule
1 & Right now \textbf{Apple} is worse then \textbf{Microsoft} ever was. & BETTER & WORSE & 1.0 \\
2 & I think \textbf{Bash} scripting is harder than \textbf{Python} though. & BETTER & WORSE & 1.0\\
3 & In my opinion \textbf{Windows 8} is worlds better then \textbf{Windows 7} & NONE & BETTER & 1.0\\
4 & In FPGAs, \textbf{Integer} or fixed-point math can often run 10 to 100 times faster than \textbf{Floating-point} 
computations. & NONE & BETTER & 1.0\\
5 & Congratulations to \textbf{Apple}; you continue to prove you are worse than \textbf{Microsoft} ever was. & BETTER & WORSE & 0.6\\
 \bottomrule
\end{tabularx}
\end{table}
...
1 & Is a \textbf{BMW} 3 series \$15,000 better than a \textbf{Ford} Focus? & BETTER & BETTER & NONE & 1.0\\
2 & \textbf{Google} is the main player now, \textbf{Microsoft} are just plain inferior in Mobile & NONE & NONE & BETTER & 1.0\\
3 & Yeah, Nvidia's \textbf{OpenCL} is not good and \textbf{CUDA} is way better. & NONE & BETTER & WORSE & 1.0\\
4 & \textbf{Python} has a better standard library, but \textbf{Perl} has a better nonstandard library & BETTER & WORSE & NONE & 0.8\\
5 & \textbf{Groovy} code often looks and feels like \textbf{Java} code, but is almost always simpler and easier to use. & NONE & NONE & BETTER & 0.4\\
...
% \centering
%	\includegraphics[width=1\textwidth]{images/experiments/conf-middle_paths_unrestricted_16_False}
%    \end{minipage} 
%\end{figure}
