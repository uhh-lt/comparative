...
# jbt data ------------------------------------------------------------------------------------------
test_questions = pd.read_csv('jbt_test_questions.csv')
input_data = pd.read_csv('data_before_removal_of_other/jbt_1224259/source1224259.csv')
input_data = input_data[input_data['label_gold'].isnull()]
answered = pd.read_csv('data_before_removal_of_other/jbt_1224259/a1224259.csv')
...
unanswered[['a','also_acceptable','b','id','marker','raw_text','text_html','text_readable']].to_csv('unanswered_jbt.csv', index=False)
